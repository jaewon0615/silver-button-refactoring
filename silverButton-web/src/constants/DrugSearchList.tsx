...
export const drugLine: IDrugLine[] = [
  {
    id: 1,
    name: "전체",
    icon: <MdDensitySmall css={s.AllIcon} />,
    style: s.AllIcon,
  },
  {
    id: 2,
    name: "없음",
    icon: <FaRegCircle css={s.circle} />,
    style: s.circle,
  },
  {
    id: 3,
    name: "(-)형",
    icon: <TbCircleHalfVertical css={s.circle} />,
    style: s.circle,
  },
  {
    id: 4,
    name: "(+)형",
    icon: <GrAddCircle css={s.circle} />,
    style: s.circle,
  },
  {
    id: 5,
    name: "기타",
    icon: <HiOutlineArrowUpCircle css={s.circle} />,
    style: s.circle,
  },
];
...
export const drugColor: IDrugColor[] = [
  ...
  { id: 7, name: "갈색", icon: <FaCircle css={s.brown} />, style: s.brown },
  {
    id: 8,
    name: "연두",
    icon: <FaCircle css={s.yellowGreen} />,
    style: s.yellowGreen,
  },
...
export const drugShape: IDrugShape[] = [
  ...
  },
  {
    id: 3,
    name: "타원형",
    icon: <TbOvalVertical css={s.circle} />,
    style: s.circle,
  },
  {
    id: 4,
    name: "사각형",
    icon: <FaRegSquare css={s.circle} />,
    style: s.circle,
  },
  {
    id: 5,
    name: "반원형",
    icon: <BiCircleHalf css={s.circle} />,
    style: s.circle,
  },
  {
    id: 6,
    name: "삼각형",
    icon: <FiTriangle css={s.circle} />,
    style: s.circle,
  },
  {
    id: 7,
    name: "마름모형",
    icon: <CgShapeRhombus css={s.circle} />,
    style: s.circle,
  },
  {
    id: 8,
    name: "장방형",
    icon: <LuRectangleHorizontal css={s.circle} />,
    style: s.circle,
  },
  {
    id: 9,
    name: "오각형",
    icon: <LuPentagon css={s.circle} />,
    style: s.circle,
  },
  {
    id: 10,
    name: "육각형",
    icon: <MdOutlineHexagon css={s.circle} />,
    style: s.circle,
  },
  {
    id: 11,
    name: "팔각형",
    icon: <FiOctagon css={s.circle} />,
    style: s.circle,
  },
];
